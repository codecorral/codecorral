# Capability: home-manager-module

## Purpose
Home Manager module that distributes OpenSpec schemas to the user-level override directory, enabling system-wide schema availability via Nix.
